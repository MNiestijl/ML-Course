...
def fit_with_Self_training(X,y, max_iterations=100, treshold=0.7)
	...
	Furthermore, define a label matrix $Y$, where the $i^{\text{th}}$ row represents the probability distribution over the different classes for the $i^{\text{th}}$ data point. The propagation algorithm is shown below:
