...
% Plot classifiers
[x1,y1] = fplot(@(x) x*theta(1)+theta(2),rl);
[x2,y2] = fplot(@(x) x*theta_weighted(1)+theta_weighted(2),rl);
plot(x1,y1,'Color', 'k', 'LineWidth', lW)
...
%saveas(gcf, 'histogram_weights.png', 'fig');
